				...
				<div className="mb-[5px]">
					<Tooltip>
						<TooltipContent hidden={remoteConfigSettings?.telemetrySetting === undefined}>
							{t("settings.telemetry.remoteManaged", "This setting is managed by your organization's remote configuration")}
						</TooltipContent>
						<TooltipTrigger asChild>
							<div className="flex items-center gap-2 mb-[5px]">
								<VSCodeCheckbox
									...
									{t("settings.telemetry", "Allow error and usage reporting")}
								</VSCodeCheckbox>
					...
					<p className="text-sm mt-[5px] text-description">
						...
						<VSCodeLink
							...
							{t("settings.telemetry.overview", "telemetry overview")}
						</VSCodeLink>{" "}
						{t("settings.telemetry.and", "and")}{" "}
						<VSCodeLink
							className="text-inherit"
							href="https://cline.bot/privacy"
							style={{ fontSize: "inherit", textDecoration: "underline" }}>
							{t("settings.telemetry.privacy", "privacy policy")}
						</VSCodeLink>{" "}
						{t("settings.telemetry.moreDetails", "for more details.")}
					</p>
				</div>
			</Section>
		</div>
