...
const AccountView = ({ onDone, clineUser, organizations, activeOrganization }: AccountViewProps) => {
	...
	return (
		<div className="fixed inset-0 flex flex-col overflow-hidden">
			<ViewHeader environment={environment} onDone={onDone} showEnvironmentSuffix title={t("viewHeader.account", "Account")} />
			...
			<div className="flex flex-col h-full">
				...
				{isClineTester && environment !== "selfHosted" && (
					<div className="w-full gap-1 items-end">
						...
						<div className="text-sm font-semibold">{t("account.environment", "Cline Environment")}</div>
						<VSCodeDropdown
