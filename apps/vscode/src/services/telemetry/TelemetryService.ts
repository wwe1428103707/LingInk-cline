			...
			if (didUserOptIn) {
				void HostProvider.window
					.showMessage({
						...
						message:
							"Anonymous LingInk error and usage reporting is enabled, but IDE telemetry is disabled. To enable error and usage reporting for this extension, enable telemetry in IDE settings.",
						options: {
							items: ["Open Settings"],
						},
					})
