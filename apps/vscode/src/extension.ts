		...
		vscode.languages.registerCodeActionsProvider(
			...
			new (class implements vscode.CodeActionProvider {
				...
				provideCodeActions(
					...
					// Add to LingInk (Always available)
					const addAction = new vscode.CodeAction("Add to LingInk", vscode.CodeActionKind.QuickFix)
					addAction.command = {
						command: commands.AddToChat,
						title: "Add to LingInk",
						arguments: [expandedRange, context.diagnostics],
					}
					actions.push(addAction)

					// Explain with LingInk (Always available)
					const explainAction = new vscode.CodeAction("Explain with LingInk", vscode.CodeActionKind.RefactorExtract) // Using a refactor kind
					explainAction.command = {
						command: commands.ExplainCode,
						title: "Explain with LingInk",
						arguments: [expandedRange],
					}
					actions.push(explainAction)

					// Improve with LingInk (Always available)
					const improveAction = new vscode.CodeAction("Improve with LingInk", vscode.CodeActionKind.RefactorRewrite) // Using a refactor kind
					improveAction.command = {
						command: commands.ImproveCode,
						title: "Improve with LingInk",
						arguments: [expandedRange],
					}
