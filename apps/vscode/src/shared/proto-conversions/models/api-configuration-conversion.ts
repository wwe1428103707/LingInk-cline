...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		academicModeApiProvider: config.academicModeApiProvider,
		academicModeApiModelId: config.academicModeApiModelId,
		academicModeThinkingBudgetTokens: config.academicModeThinkingBudgetTokens,
		geminiAcademicModeThinkingLevel: config.geminiAcademicModeThinkingLevel,
		academicModeReasoningEffort: config.academicModeReasoningEffort,
		academicModeVsCodeLmModelSelector: config.academicModeVsCodeLmModelSelector,
		academicModeAwsBedrockCustomSelected: config.academicModeAwsBedrockCustomSelected,
		academicModeAwsBedrockCustomModelBaseId: config.academicModeAwsBedrockCustomModelBaseId as string | undefined,
		academicModeOpenRouterModelId: config.academicModeOpenRouterModelId,
		academicModeOpenRouterModelInfo: convertModelInfoToProtoOpenRouter(config.academicModeOpenRouterModelInfo),
		academicModeClineModelId: config.academicModeClineModelId,
		academicModeClineModelInfo: convertModelInfoToProtoOpenRouter(config.academicModeClineModelInfo),
		academicModeClinePassModelId: config.academicModeClinePassModelId,
		academicModeClinePassModelInfo: convertModelInfoToProtoOpenRouter(config.academicModeClinePassModelInfo),
		academicModeOpenAiModelId: config.academicModeOpenAiModelId,
		academicModeOpenAiModelInfo: convertOpenAiCompatibleModelInfoToProto(config.academicModeOpenAiModelInfo),
		academicModeOllamaModelId: config.academicModeOllamaModelId,
		academicModeLmStudioModelId: config.academicModeLmStudioModelId,
		academicModeLiteLlmModelId: config.academicModeLiteLlmModelId,
		academicModeLiteLlmModelInfo: convertLiteLLMModelInfoToProto(config.academicModeLiteLlmModelInfo),
		academicModeRequestyModelId: config.academicModeRequestyModelId,
		academicModeRequestyModelInfo: convertModelInfoToProtoOpenRouter(config.academicModeRequestyModelInfo),
		academicModeTogetherModelId: config.academicModeTogetherModelId,
		academicModeFireworksModelId: config.academicModeFireworksModelId,
		academicModeGroqModelId: config.academicModeGroqModelId,
		academicModeGroqModelInfo: convertModelInfoToProtoOpenRouter(config.academicModeGroqModelInfo),
		academicModeBasetenModelId: config.academicModeBasetenModelId,
		academicModeBasetenModelInfo: convertModelInfoToProtoOpenRouter(config.academicModeBasetenModelInfo),
		academicModeHuggingFaceModelId: config.academicModeHuggingFaceModelId,
		academicModeHuggingFaceModelInfo: convertModelInfoToProtoOpenRouter(config.academicModeHuggingFaceModelInfo),
		academicModeSapAiCoreModelId: config.academicModeSapAiCoreModelId,
		academicModeHuaweiCloudMaasModelId: config.academicModeHuaweiCloudMaasModelId,
		academicModeHuaweiCloudMaasModelInfo: convertModelInfoToProtoOpenRouter(config.academicModeHuaweiCloudMaasModelInfo),
		academicModeSapAiCoreDeploymentId: config.academicModeSapAiCoreDeploymentId,
		academicModeOcaModelId: config.academicModeOcaModelId,
		academicModeOcaModelInfo: convertOcaModelInfoToProtoOcaModelInfo(config.academicModeOcaModelInfo),
		academicModeOcaReasoningEffort: config.academicModeOcaReasoningEffort,
		academicModeAihubmixModelId: config.academicModeAihubmixModelId,
		academicModeAihubmixModelInfo: convertOpenAiCompatibleModelInfoToProto(config.academicModeAihubmixModelInfo),
		academicModeHicapModelId: config.academicModeHicapModelId,
		academicModeHicapModelInfo: convertModelInfoToProtoOpenRouter(config.academicModeHicapModelInfo),
		academicModeNousResearchModelId: config.academicModeNousResearchModelId,
		academicModeVercelAiGatewayModelId: config.academicModeVercelAiGatewayModelId,
		academicModeVercelAiGatewayModelInfo: convertModelInfoToProtoOpenRouter(config.academicModeVercelAiGatewayModelInfo),
	}
}
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		academicModeApiProvider:
			protoConfig.academicModeApiProvider !== undefined ? convertProtoToApiProvider(protoConfig.academicModeApiProvider) : undefined,
		academicModeApiModelId: protoConfig.academicModeApiModelId,
		academicModeThinkingBudgetTokens: protoConfig.academicModeThinkingBudgetTokens,
		geminiAcademicModeThinkingLevel: protoConfig.geminiAcademicModeThinkingLevel,
		academicModeReasoningEffort: protoConfig.academicModeReasoningEffort as OpenaiReasoningEffort | undefined,
		academicModeVsCodeLmModelSelector: protoConfig.academicModeVsCodeLmModelSelector,
		academicModeAwsBedrockCustomSelected: protoConfig.academicModeAwsBedrockCustomSelected,
		academicModeAwsBedrockCustomModelBaseId: protoConfig.academicModeAwsBedrockCustomModelBaseId as BedrockModelId | undefined,
		academicModeOpenRouterModelId: protoConfig.academicModeOpenRouterModelId,
		academicModeOpenRouterModelInfo: convertProtoToModelInfo(protoConfig.academicModeOpenRouterModelInfo),
		academicModeClineModelId: protoConfig.academicModeClineModelId,
		academicModeClineModelInfo: convertProtoToModelInfo(protoConfig.academicModeClineModelInfo),
		academicModeClinePassModelId: protoConfig.academicModeClinePassModelId,
		academicModeClinePassModelInfo: convertProtoToModelInfo(protoConfig.academicModeClinePassModelInfo),
		academicModeOpenAiModelId: protoConfig.academicModeOpenAiModelId,
		academicModeOpenAiModelInfo: convertProtoToOpenAiCompatibleModelInfo(protoConfig.academicModeOpenAiModelInfo),
		academicModeOllamaModelId: protoConfig.academicModeOllamaModelId,
		academicModeLmStudioModelId: protoConfig.academicModeLmStudioModelId,
		academicModeLiteLlmModelId: protoConfig.academicModeLiteLlmModelId,
		academicModeLiteLlmModelInfo: convertProtoToLiteLLMModelInfo(protoConfig.academicModeLiteLlmModelInfo),
		academicModeRequestyModelId: protoConfig.academicModeRequestyModelId,
		academicModeRequestyModelInfo: convertProtoToModelInfo(protoConfig.academicModeRequestyModelInfo),
		academicModeTogetherModelId: protoConfig.academicModeTogetherModelId,
		academicModeFireworksModelId: protoConfig.academicModeFireworksModelId,
		academicModeGroqModelId: protoConfig.academicModeGroqModelId,
		academicModeGroqModelInfo: convertProtoToModelInfo(protoConfig.academicModeGroqModelInfo),
		academicModeBasetenModelId: protoConfig.academicModeBasetenModelId,
		academicModeBasetenModelInfo: convertProtoToModelInfo(protoConfig.academicModeBasetenModelInfo),
		academicModeHuggingFaceModelId: protoConfig.academicModeHuggingFaceModelId,
		academicModeHuggingFaceModelInfo: convertProtoToModelInfo(protoConfig.academicModeHuggingFaceModelInfo),
		academicModeSapAiCoreModelId: protoConfig.academicModeSapAiCoreModelId,
		academicModeHuaweiCloudMaasModelId: protoConfig.academicModeHuaweiCloudMaasModelId,
		academicModeHuaweiCloudMaasModelInfo: convertProtoToModelInfo(protoConfig.academicModeHuaweiCloudMaasModelInfo),
		academicModeSapAiCoreDeploymentId: protoConfig.academicModeSapAiCoreDeploymentId,
		academicModeOcaModelId: protoConfig.academicModeOcaModelId,
		academicModeOcaModelInfo: convertProtoOcaModelInfoToOcaModelInfo(protoConfig.academicModeOcaModelInfo),
		academicModeOcaReasoningEffort: protoConfig.academicModeOcaReasoningEffort,
		academicModeAihubmixModelId: protoConfig.academicModeAihubmixModelId,
		academicModeAihubmixModelInfo: convertProtoToOpenAiCompatibleModelInfo(protoConfig.academicModeAihubmixModelInfo),
		academicModeHicapModelId: protoConfig.academicModeHicapModelId,
		academicModeHicapModelInfo: convertProtoToModelInfo(protoConfig.academicModeHicapModelInfo),
		academicModeNousResearchModelId: protoConfig.academicModeNousResearchModelId,
		academicModeVercelAiGatewayModelId: protoConfig.academicModeVercelAiGatewayModelId,
		academicModeVercelAiGatewayModelInfo: convertProtoToModelInfo(protoConfig.academicModeVercelAiGatewayModelInfo),
	}
}
