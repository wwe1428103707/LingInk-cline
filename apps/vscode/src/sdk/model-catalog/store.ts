...
const modelInfoKeysByProvider: Partial<Record<string, ModelInfoKeys>> = {
	openrouter: {
		...
		academic: "academicModeOpenRouterModelInfo",
	},
	...
	huggingface: {
		...
		academic: "academicModeHuggingFaceModelInfo",
	},
	"huawei-cloud-maas": {
		plan: "planModeHuaweiCloudMaasModelInfo",
		act: "actModeHuaweiCloudMaasModelInfo",
		academic: "academicModeHuaweiCloudMaasModelInfo",
	},
	...
	"vercel-ai-gateway": {
		...
		academic: "academicModeVercelAiGatewayModelInfo",
	},
}
