...
export function buildSdkProviderConfig(
	...
	const providerId = (mode === "plan" ? configuration.planModeApiProvider : mode === "academic" ? configuration.academicModeApiProvider : configuration.actModeApiProvider) ?? "cline"
	...
	const thinkingBudgetTokens =
		mode === "plan" ? configuration.planModeThinkingBudgetTokens : mode === "academic" ? configuration.academicModeThinkingBudgetTokens : configuration.actModeThinkingBudgetTokens
	const reasoningEffort = mode === "plan" ? configuration.planModeReasoningEffort : mode === "academic" ? configuration.academicModeReasoningEffort : configuration.actModeReasoningEffort
